...
# 사용자가 제시한 주제를 기반으로 질문의 숨겨진 의도·감정·목적을 분석한 뒤, 이를 활용하여 보고서 작성에 가장 효과적인 AI 요청문으로 재작성합니다.
...
# 출력형태(output_format): 보고서의 필수 섹션과 각 섹션에 포함되어야 할 주요 내용을 2~3문단으로 명시한다.
...
#         "SUMMARY": "전체 내용을 압축한 요약",
#         "CONCLUSION": "최종 결론, 전망, 전략적 제언"
#     },
#     "task": "수행해야 할 구체적 작업 (단계별, 구조화)"
# }
# > output_format의 각 섹션은 반드시 2~3문단으로 작성되어야 하며,
# ---
...
응답은 반드시 다음 JSON 형식으로 제공하세요:
{
    ...
    "output_format": {
        ...
        "DATE": "기준 시점, 표현 방식 등 날짜 처리 기준 (1문장)",
        "BACKGROUND": "반드시 포함해야 할 배경/문제 맥락/환경 요소 요약 (2-3문장 또는 bullet)",
        "MAIN_CONTENT": "핵심 분석 범위, 주요 지표·데이터·논점 목록 (2-4문장 또는 bullet)",
        "SUMMARY": "요약에서 강조해야 할 핵심 포인트/메시지 (2-3문장 또는 bullet)",
        "CONCLUSION": "결론·전망·전략적 제언에서 다뤄야 할 방향성 요약 (2-3문장 또는 bullet)"
    },
    "task": "수행해야 할 구체적 작업 (단계별, 구조화)"
}
